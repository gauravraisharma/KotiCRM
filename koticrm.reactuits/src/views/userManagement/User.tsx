...
const User = () => {
  ...
  const getForm12BbsById = async (employeeId: string) => {
    try {
      ...
      toast.error("Failed to fetch 12 BB data");
    }
  };
  useEffect(() => {
    if (employeeId) {
  ...
  useEffect(() => {
    console.log(employee12BBData);  // Log the data to check structure
  }, [employee12BBData]);
                            ...
                            <CCol md="12" key={index}>
                              <div>
                                <p style={{ fontWeight: 'bold' }}>
                                  ...
                                  <u>Financial year {element.financialYear && element.financialYear.financialYearName ? element.financialYear.financialYearName : "No Financial Year"}</u>
                                </p>
                              </div>
                            </CCol>
                          </CCol>
