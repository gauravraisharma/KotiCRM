...
const DetailRow = ({ label, value }: DetailRowProps) => (
    <div className="mb-2 d-flex align-items-center">
        <span className="font-weight-bold" style={{ color: "grey", flex: "2" }}>{label}</span>
        <span className="ms-2" style={{ flex: "1" }}>:</span>
        <span className="ms-2" style={{ flex: "4" }}>{value}</span>
    </div>
);
        ...
        <CCard className="mb-4">
            ...
            <CCardBody>
                <CCardText>
                    <CRow>
                        <CCol xs={6}>
                            <DetailRow label="Name" value={`${fetchedContact.firstName} ${fetchedContact.lastName}`} />
                            <DetailRow label="Skype ID" value={fetchedContact.skypeID} />
                            <DetailRow label="Title" value={fetchedContact.title} />
                            <DetailRow label="Account Name" value={fetchedContact.accountName} />
                        ...
                        <CCol xs={6}>
                            ...
                            <DetailRow label="Twitter URL" value={fetchedContact.twitterURL} />
                            <DetailRow label="Date Of Birth" value={formatDate(fetchedContact.dateOfBirth)} />
                            <DetailRow label="Mobile" value={fetchedContact.mobile} />
                            <DetailRow label="Other Phone" value={fetchedContact.otherPhone} />
                            <DetailRow label="Secondary Email" value={fetchedContact.secondaryEmail} />
                            <DetailRow label="Mailing Street" value={fetchedContact.mailingStreet} />
                            <DetailRow label="State" value={fetchedContact.state} />
                            <DetailRow label="Description" value={fetchedContact.description} />
                        </CCol>
                    </CRow>
                </CCardText>
            </CCardBody>
